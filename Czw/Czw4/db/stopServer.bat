...
"%JAVA_HOME%\bin\java" -Dderby.system.home=E:\Workspace\IntelliJIDEA\TPO\Czw\Czw4\db\DerbyDbs -cp "%DERBY_JARS%" org.apache.derby.drda.NetworkServerControl shutdown
